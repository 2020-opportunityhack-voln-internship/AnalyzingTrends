...
def scrape_askdruniverse(search_query, website, website_link,chrome_options):
...
# csv file is saved as "query + "_" +  website_name" + .csv
def scrape_teachengineering(search_query, website, website_link,chrome_options):
...
def scrapWebsite(search_query, website):
    ...
    if website == 'askdruniverse':
        ...
        scrape_askdruniverse(search_query, website, website_link, chrome_options)

    if website == 'teachengineering':
        website_link = 'https://www.teachengineering.org/k12engineering/what'
        scrape_teachengineering(search_query, website, website_link, chrome_options)
